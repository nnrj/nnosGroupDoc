...
SectorsPerTrack		dw 03fh
NumberOfHeads		dw 255
HiddenSectors		dd 3fh
TotalSectorsBig		dd 4192902
; FAT32 Inserted Info
SectorsPerFatBig	dd	4087
ExtendedFlags		dw	0
FSVersion			dw	0
RootDirStartCluster	dd	2
FSInfoSector		dw	1
...
LoadExtraBootCode:
		...
		;mov  eax,0eh
		mov  eax,03h                            ; 这个扇区号是以FAT32分区的逻辑1号扇区为基准的物理是66扇区，因为63是PBR，64号扇区是INFOFS扇区记录了分区可用的总蔟数 
...
LoadFileDone:
		...
		;PUSH  WORD 0C200H      ；30天资质操作系统加载在0C200H,这个地址跟loader文件的ORG 后的地址对应
